...
const PRESETS: Preset[] = [
  ...
  { label: 'Entity search', method: 'GET', path: '/api/entities/search?q=' },
  { label: 'Entity risk', method: 'GET', path: '/api/entities/{entity_id}/risk' },
  { label: 'Shortest path', method: 'GET', path: '/api/entities/shortest-path?source=&target=' },
