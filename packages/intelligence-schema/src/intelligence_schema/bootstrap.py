...
def register_schema() -> None:
    ...
    SchemaRegistry.register_global_vertex("person", PersonVertex)
    SchemaRegistry.register_global_vertex("company", CompanyVertex)
    SchemaRegistry.register_global_vertex("address", AddressVertex)
    SchemaRegistry.register_global_vertex("phone", PhoneVertex)
    SchemaRegistry.register_global_vertex("email", EmailVertex)
    SchemaRegistry.register_global_vertex("bank_account", BankAccountVertex)
    SchemaRegistry.register_global_vertex("transaction", TransactionVertex)
    SchemaRegistry.register_global_vertex("document", DocumentVertex)
    SchemaRegistry.register_global_vertex("country", CountryVertex)
    SchemaRegistry.register_global_vertex("website", WebsiteVertex)
    SchemaRegistry.register_global_vertex("domain", DomainVertex)
    SchemaRegistry.register_global_vertex("ip_address", IPAddressVertex)
    SchemaRegistry.register_global_vertex("crypto_wallet", CryptoWalletVertex)
    SchemaRegistry.register_global_vertex("sanction_entry", SanctionEntryVertex)
    SchemaRegistry.register_global_vertex("watchlist_entry", WatchlistEntryVertex)

    SchemaRegistry.register_global_edge("RELATED_TO", RelatedToEdge)
    SchemaRegistry.register_global_edge("WORKS_AT", WorksAtEdge)
    SchemaRegistry.register_global_edge("OWNS", OwnsEdge)
    SchemaRegistry.register_global_edge("DIRECTOR_OF", DirectorOfEdge)
    SchemaRegistry.register_global_edge("SHAREHOLDER_OF", ShareholderOfEdge)
    SchemaRegistry.register_global_edge("LIVES_AT", LivesAtEdge)
    SchemaRegistry.register_global_edge("TRANSFERRED_TO", TransferredToEdge)
    SchemaRegistry.register_global_edge("LINKED_WITH", LinkedWithEdge)
    SchemaRegistry.register_global_edge("COMMUNICATED_WITH", CommunicatedWithEdge)
    SchemaRegistry.register_global_edge("REGISTERED_TO", RegisteredToEdge)
    SchemaRegistry.register_global_edge("LOCATED_AT", LocatedAtEdge)
